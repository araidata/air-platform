...
- `docs/architecture/api-first-platform-strategy.md`
- `docs/ai-context/constraints.md`
- `docs/decisions/`

Review the proposed change against the repository architecture.

Focus on:

- Whether it preserves single-VM Docker Compose simplicity.
