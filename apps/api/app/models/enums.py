...
class EvidenceType(str, Enum):
    ...
    bilingual_screenshot = "bilingual_screenshot"
    translated_response = "translated_response"
    escalation_screenshot = "escalation_screenshot"
    policy_comparison = "policy_comparison"
    accessibility_evidence = "accessibility_evidence"
    human_review_workflow = "human_review_workflow"
    appeal_process_documentation = "appeal_process_documentation"
    fairness_review_note = "fairness_review_note"
