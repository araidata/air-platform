          ...
          {selected ? (
            <div className="mt-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {selected.metadata_json?.trace_id ? <StatusPill value="trace_linked" /> : null}
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <Info
                  label="Trace"
                  value={
                    typeof selected.metadata_json?.trace_id === "string"
                      ? selected.metadata_json.trace_id
                      : "Not recorded"
                  }
                  mono
                />
                <Info
                  label="Scanner run"
                  value={
                    typeof selected.metadata_json?.scanner_run_id === "string"
                      ? selected.metadata_json.scanner_run_id
                      : "Not linked"
                  }
                  mono
                />
              ...
              <div className="rounded-lg border border-white/10 bg-black/20 p-3">
                ...
                <ol className="mt-3 space-y-2 text-sm text-zinc-400">
                  ...
                  {selected.metadata_json?.trace_id ? <li>Trace reference {String(selected.metadata_json.trace_id).slice(0, 8)}</li> : null}
